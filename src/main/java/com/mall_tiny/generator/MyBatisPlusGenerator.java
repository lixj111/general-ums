package com.mall_tiny.generator;
...
public class MyBatisPlusGenerator {
    /**
     * mybatis_plus代码生成器，效果类似于mybatis_plus插件生成效果（都可自行配置）
     * */
    public static void main(String[] args) {
        String projectPath = System.getProperty("user.dir"); //D:\Codes\java\mall_tiny
        String moduleName = scanner("模块名"); // ums
        String[] tableNames = scanner("请输入表名，使用多个英文逗号分割").split(",");

        // 代码生成器
        // 创建一个AutoGenerator实例，并初始化数据源配置。
    ...
    * */
    private static GlobalConfig initGlobalConfig(String projectPath) {
        return new GlobalConfig.Builder()
                .outputDir(projectPath + "/src/main/java") //D:\Codes\java\mall_tiny\src\main\java
                .author("baosight")
                .disableOpenDir()
                .enableSwagger()
                .fileOverride()
    ...
    * */
    ...
    private static PackageConfig initPackageConfig(String projectPath, String moduleName) {
        ...
        return new PackageConfig.Builder()
                ...
                .parent(props.getStr("package.base")) //com.mall_tiny.modules
                .entity("model")
